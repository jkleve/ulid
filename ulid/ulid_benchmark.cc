...
TEST_CASE("Benchmark now_random_generator", "[benchmark]") {
    BENCHMARK_ADVANCED("now()")(Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("from_string()")(Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("to_string()")(Catch::Benchmark::Chronometer meter) {
